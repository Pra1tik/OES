    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('response', models.ManyToManyField(related_name='response', to='questionForm.answer')),
                ('response_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='response_to', to='questionForm.form')),
            ],
        ),
        migrations.CreateModel(
            name='Questions',
            fields=[
                ...
                ('choices', models.ManyToManyField(related_name='choices', to='questionForm.choices')),
            ],
        ),
        migrations.AddField(
            model_name='form',
            name='questions',
            field=models.ManyToManyField(related_name='questions', to='questionForm.questions'),
        ),
        migrations.AddField(
            model_name='answer',
            name='answer_to',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answer_to', to='questionForm.questions'),
        ),
    ]
